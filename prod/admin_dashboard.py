...
<body>
    <div class="container mt-4">
        ...
        <ul class="nav nav-tabs" id="dashboardTabs" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <a class="nav-link" href="/admin-dashboard-08x7z9y2-yoursecretword/documents">Documents</a>
            </li>
        </ul>
...
@admin_dashboard.route('/documents')
def documents():
...
@admin_dashboard.route('/document/<doc_id>', methods=['GET'])
...
@admin_dashboard.route('/document/<doc_id>', methods=['DELETE'])
def delete_document(doc_id):
    ...
    try:
        ...
        with connect_to_db() as conn:
            ...
            success = document_handler.delete_document_vectors(namespace, doc_id)
...
@admin_dashboard.route('/upload-document', methods=['POST'])
def upload_document():
    ...
    try:
        ...
        with connect_to_db() as conn:
            ...
            # Process document
            doc_result = document_handler.process_document(
                file_data=file_data,
                filename=filename,
...
@admin_dashboard.route('/create-initial-document/<chatbot_id>', methods=['POST'])
def create_initial_document(chatbot_id):
    ...
    try:
        ...
        with connect_to_db() as conn:
            ...
            # Create document
            doc_result = document_handler.create_initial_document_from_website(
                chatbot_id=chatbot_id,
                namespace=namespace,
